...
//    }
//
//    // Create (Add a book to the bookshelf)
//
//   @PostMapping("create")
//    public BookShelf addBook(@RequestBody Book book) {
//        return bookshelfRepository.save(book);
//    }
//
//    // Read (Display all books on the bookshelf)
//
//    public Object displayBooks() {
//        if (bookshelf.isEmpty()) {
//            return ("The bookshelf is empty.");
//        } else {
//            return ("Books on the bookshelf:");
//        }
//    }
//
//    // Update (Edit book details)
//
//    public String editBook(String oldTitle, String newTitle, String newAuthor) {
...
//            }
//        }
//        return ("Book not found. Update failed.");
//    }
//
//    // Delete (Remove a book from the bookshelf)
//
...
//            }
//        }
//        return ("Book not found. Deletion failed.");
//    }
//}
